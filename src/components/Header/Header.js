        ...
        <Switch>
            ...
            <Route path={["/movies", "/saved-movies", "/profile"]}>
                <header className="header header_type_auth">
                    <div className="header__auth header__auth_type_right"> {/* Дополнительный контейнер нужен для корректного выравнивания элементов в хедере гридом. */}
                        <Link to="/"><img className="header__logo" src={projectLogo} alt="Логотип сервиса Movies Explorer" /></Link>
                        <Navigation
                    isOpen={props.isOpen}
                    onClose={props.onClose}
                    ...
                    <div className="header__auth header__auth_type_left"> {/* Дополнительный контейнер нужен для корректного выравнивания элементов в хедере гридом. */}
