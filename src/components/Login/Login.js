        ...
        <div className="login">
            <div className="login__container">
                ...
                <form className="login__form" onSubmit={handleSubmit}>
                    ...
                    name="email"
                    type="email"
                    className={`login__input ${(emailIncorrect && emailError) ? 'login__input_error' : ''}`}
                    ...
                    onBlur={blurHandler}
                    />
                    { (emailIncorrect && emailError) && <span id="login-input-error" className="login__input-error">{emailError}</span> }
                    <p className="login__input-name">Пароль</p>
                    <input
                    id="input-user-password"
                    name="password"
                    type="password"
                    className={`login__input ${(passwordIncorrect && passwordError) ? 'login__input_error' : ''}`}
                    ...
                    onBlur={blurHandler}
                    />
                    { (passwordIncorrect && passwordError) && <span id="login-input-error" className="login__input-error">{passwordError}</span> }
